...
if f is not None:
    ...
    os.chdir(r"C:\Users\alhas\OneDrive\Desktop\Project\Supermarket Dashboard")
    df = pd.read_csv("Superstore.csv", on_bad_lines='skip', sep='\t')
...
with cl2:
    with st.expander("Region_ViewData"):
        ...
        st.download_button(label="Download Data", data=csv, file_name="Region.csv", mime="text/csv",
                           help='Click here to download the data as a CSV')
